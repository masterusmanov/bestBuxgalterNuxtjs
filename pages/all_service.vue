<template>
    ...
    <div class="container mx-auto mt-[30px]">
      ...
      <div>
        <div class="grid md:grid-cols-2 justify-between gap-6 ">
      ...
      <button @click="back.go(-1)" class="px-4 py-2 bg-[#073843] text-white rounded-lg float-right my-[15px] mr-2">Orqaga</button>
    </div>
